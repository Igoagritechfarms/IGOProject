            ...
            <div class="welcomesec secpadd">
                <div class="container">
                    <div
                        ...
                        <h2>PRIVACY <span class="main-color"> POLICY</span></h2>
                        <span class="fh-icon"><i
                                class="flaticon-nature-3"></i></span>
                    </div>
                    <h4 class="text-left">Effective date: 2022-07-18 </h4>
                    <h3 class="srvmdlhd"><span class="main-color">1. Introduction</span> </h3>
                    <p>Welcome to IGO Agri Techfarms.</p>

                    <p>IGO Agri Techfarms (“us”, “we”, or “our”) operates www.igoagritechfarms.com (hereinafter referred to as “Service”).</p>

                    <p>Our Privacy Policy governs your visit to www.igoagritechfarms.com, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
                    ...
                    <h3 class="srvmdlhd"><span class="main-color">2. Definitions</span> </h3>
                    <p>SERVICE means the www.igoagritechfarms.com website operated by IGO Agri Techfarms.</p>
                    ...
                    <h3 class="srvmdlhd"><span class="main-color">3. Information Collection and Use</span> </h3>
                    <p>We collect several different types of information for various purposes to provide and improve our Service to you.</p>

                    <h3 class="srvmdlhd"><span class="main-color">4. Types of Data Collected</span> </h3>
...
<h5><b>Examples of Cookies we use:</b></h5>
...
<h5><b>Other Data</b></h5>

<p>While using our Service, we may also collect the following information: sex, age, date of birth, place of birth, passport details, citizenship, registration at place of residence and actual address, telephone number (work, mobile), details of documents on education, qualification, professional training, employment agreements, NDA agreements, information on bonuses and compensation, information on marital status, family members, social security (or other taxpayer identification) number, office location and other data.</p>
                    <h3 class="srvmdlhd"><span class="main-color">5. Use of Data</span> </h3>

                    <p>IGO Agri Techfarms uses the collected data for various purposes:</p>
   ...
   <h3 class="srvmdlhd"><span class="main-color">6. Retention of Data</span> </h3>
   ...
   <h3 class="srvmdlhd"><span class="main-color">7. Transfer of Data</span> </h3>
   ...
   <p>IGO Agri Techfarms will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>


   <h3 class="srvmdlhd"><span class="main-color">8. Disclosure of Data</span> </h3>
   ...
   <h3 class="srvmdlhd"><span class="main-color">9. Security of Data</span> </h3>

   <p>The security of your data is important to us but remember that no method of transmission over the Internet or method of electronic storage is 100% secure. While we strive to use commercially acceptable means to protect your Personal Data, we cannot guarantee its absolute security.</p>

<h3 class="srvmdlhd"><span class="main-color">10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)</span> </h3>
...
<p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at igowebsites@gmail.com.</p>
...
<h3 class="srvmdlhd"><span class="main-color">11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</span> </h3>
...
<p>0.4. users are able to change their personal information by emailing us at igowebsites@gmail.com.</p>
...
<h3 class="srvmdlhd"><span class="main-color">12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</span> </h3>
...
<p>To exercise your California data protection rights described above, please send your request(s) by email: igowebsites@gmail.com.</p>

<p>Your data protection rights, described above, are covered by the CCPA, short for the California Consumer Privacy Act. To find out more, visit the official California Legislative Information website. The CCPA took effect on 01/01/2020.</p>


<h3 class="srvmdlhd"><span class="main-color">13. Service Providers</span> </h3>
...
<h3 class="srvmdlhd"><span class="main-color">14. Analytics</span> </h3>

<p>We may use third-party Service Providers to monitor and analyze the use of our Service.</p>


<h3 class="srvmdlhd"><span class="main-color">15. CI/CD tools</span> </h3>

<p>We may use third-party Service Providers to automate the development process of our Service.</p>


<h3 class="srvmdlhd"><span class="main-color">16. Behavioral Remarketing</span> </h3>

<p>We may use remarketing services to advertise on third party websites to you after you visited our Service. We and our third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.</p>


<h3 class="srvmdlhd"><span class="main-color">17. Payments</span> </h3>
...
<h3 class="srvmdlhd"><span class="main-color">18. Links to Other Sites</span> </h3>
...
<h3 class="srvmdlhd"><span class="main-color">19. Children’s Privacy</span> </h3>

Our Services are not intended for use by children under the age of 18 (“Child” or “Children”).</p>

<p>We do not knowingly collect personally identifiable information from Children under 18. If you become aware that a Child has provided us with Personal Data, please contact us. If we become aware that we have collected Personal Data from Children without verification of parental consent, we take steps to remove that information from our servers.</p>

<h3 class="srvmdlhd"><span class="main-color">20. Changes to This Privacy Policy</span> </h3>
...
<h3 class="srvmdlhd"><span class="main-color">21. Contact Us</span> </h3>

<p>If you have any questions about this Privacy Policy, please contact us by email: <a href="mailto:igowebsites@gmail.com">igowebsites@gmail.com</a>.</p>
